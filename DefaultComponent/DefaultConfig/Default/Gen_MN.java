...
public class Gen_MN extends Gen_Neuron {
    ...
    protected int NMJSynDelay;		//## attribute NMJSynDelay 
    
    protected double NMJcoeff;		//## attribute NMJcoeff 
    
    protected ArrayList<String> NMJsignalArrivalsList;		//## attribute NMJsignalArrivalsList 
    
    protected double[] NMJsynWeights;		//## attribute NMJsynWeights 
    ...
    //## auto_generated 
    public int getNMJSynDelay() {
        return NMJSynDelay;
    }
    
    //## auto_generated 
    public void setNMJSynDelay(int p_NMJSynDelay) {
        NMJSynDelay = p_NMJSynDelay;
    }
    ...
    //## auto_generated 
    public ArrayList<String> getNMJsignalArrivalsList() {
        return NMJsignalArrivalsList;
    }
    
    //## auto_generated 
    public void setNMJsignalArrivalsList(ArrayList<String> p_NMJsignalArrivalsList) {
        NMJsignalArrivalsList = p_NMJsignalArrivalsList;
    }
    
    //## auto_generated 
    public double getNMJsynWeights(int i1) {
        return NMJsynWeights[i1];
    }
    
    //## auto_generated 
    public void setNMJsynWeights(int i1, double p_NMJsynWeights) {
        NMJsynWeights[i1] = p_NMJsynWeights;
    }
    ...
    public class Reactive extends RiJStateReactive {
        ...
        public void firingStateEnter() {
            ...
            setTransTime(itsManager.getClockTime() + getDecaySSteps());
            //addEJlist();
            addCHlist();
            gen(new evSendTrig());
