/*********************************************************************
	...
	Model Element	: Gen_BS
//!	Generated Date	: Tue, 19, Apr 2016 
	File Path	: DefaultComponent/DefaultConfig/Default/Gen_BS.java
*********************************************************************/
...
//## class Gen_BS 
public class Gen_BS extends Gen_Neuron {
    ...
    protected ArrayList<Gen_BS> itsGen_BS = itsGen_BS = new ArrayList<Gen_BS>();		//## link itsGen_BS 
    
    protected ArrayList<Gen_BS> itsGen_BS_1 = itsGen_BS_1 = new ArrayList<Gen_BS>();		//## link itsGen_BS_1 
    
    protected ArrayList<Gen_BS> itsGen_BS_2 = itsGen_BS_2 = new ArrayList<Gen_BS>();		//## link itsGen_BS_2 
    ...
    //## operation Gen_BS() 
    public  Gen_BS(RiJThread p_thread) {
        super(p_thread);
    ...
    public void updateDeltaActivation() {
        ...
        for (int i = 0; i < itsGen_IN.size(); i++) {  
        	...
        	if (NMJsynWeights[dest_neuron_number-1] != 0) {
        		//add command string to list. the format is: arrivalTime, targetNeuron, type
        		//target neuron is NOT between 1,...,79 but it's the index in itsGen_IN array - easier this way, saves double checking...
        		nmj_activation += NMJsynWeights[dest_neuron_number-1]*(itsGen_IN.get(i).getActivation() - getActivation()/2);
        		num_of_nmj_synapses += NMJsynWeights[dest_neuron_number-1]; 
        	}		
        }
        ...
        for (int i = 0; i < itsGen_SN.size(); i++) {  
        	...
        	if (NMJsynWeights[dest_neuron_number-1] != 0) {
        		//add command string to list. the format is: arrivalTime, targetNeuron, type
        		//target neuron is NOT between 1,...,79 but it's the index in itsGen_SN array - easier this way, saves double checking...
        		nmj_activation += NMJsynWeights[dest_neuron_number-1]*(itsGen_SN.get(i).getActivation() - getActivation()/2);
        		num_of_nmj_synapses += NMJsynWeights[dest_neuron_number-1]; 
        	}		
        }
        ...
        for (int i = 0; i < itsGen_MN.size(); i++) {  
        	...
        	if (NMJsynWeights[dest_neuron_number-1] != 0) {
        		...
        		nmj_activation += NMJsynWeights[dest_neuron_number-1]*(itsGen_MN.get(i).getActivation() - getActivation()/2);
        		num_of_nmj_synapses += NMJsynWeights[dest_neuron_number-1]; 
        	}		
        }
    ...
    //## auto_generated 
    public ListIterator<Gen_BS> getItsGen_BS() {
        ListIterator<Gen_BS> iter = itsGen_BS.listIterator();
        return iter;
    }
    
    //## auto_generated 
    public void addItsGen_BS(Gen_BS p_Gen_BS) {
        itsGen_BS.add(0, p_Gen_BS);
    }
    
    //## auto_generated 
    public void removeItsGen_BS(Gen_BS p_Gen_BS) {
        itsGen_BS.remove(p_Gen_BS);
    }
    
    //## auto_generated 
    public void clearItsGen_BS() {
        itsGen_BS.clear();
    }
    
    //## auto_generated 
    public ListIterator<Gen_BS> getItsGen_BS_1() {
        ListIterator<Gen_BS> iter = itsGen_BS_1.listIterator();
        return iter;
    }
    
    //## auto_generated 
    public void _addItsGen_BS_1(Gen_BS p_Gen_BS) {
        itsGen_BS_1.add(0, p_Gen_BS);
    }
    
    //## auto_generated 
    public void addItsGen_BS_1(Gen_BS p_Gen_BS) {
        if(p_Gen_BS != null)
            {
                p_Gen_BS._addItsGen_BS_2(this);
            }
        _addItsGen_BS_1(p_Gen_BS);
    }
    
    //## auto_generated 
    public void _removeItsGen_BS_1(Gen_BS p_Gen_BS) {
        itsGen_BS_1.remove(p_Gen_BS);
    }
    
    //## auto_generated 
    public void removeItsGen_BS_1(Gen_BS p_Gen_BS) {
        if(p_Gen_BS != null)
            {
                p_Gen_BS._removeItsGen_BS_2(this);
            }
        _removeItsGen_BS_1(p_Gen_BS);
    }
    
    //## auto_generated 
    public void _clearItsGen_BS_1() {
        itsGen_BS_1.clear();
    }
    
    //## auto_generated 
    public void clearItsGen_BS_1() {
        ListIterator<Gen_BS> iter = itsGen_BS_1.listIterator();
        while (iter.hasNext()){
            Gen_BS current = itsGen_BS_1.get(iter.nextIndex());
            if(current != null)
                {
                    current._removeItsGen_BS_2(this);
                }
            iter.next();
        }
        _clearItsGen_BS_1();
    ...
    //## auto_generated 
    public ListIterator<Gen_BS> getItsGen_BS_2() {
        ListIterator<Gen_BS> iter = itsGen_BS_2.listIterator();
        return iter;
    }
    
    //## auto_generated 
    public void _addItsGen_BS_2(Gen_BS p_Gen_BS) {
        itsGen_BS_2.add(0, p_Gen_BS);
    }
    
    //## auto_generated 
    public void addItsGen_BS_2(Gen_BS p_Gen_BS) {
        if(p_Gen_BS != null)
            {
                p_Gen_BS._addItsGen_BS_1(this);
            }
        _addItsGen_BS_2(p_Gen_BS);
    }
    
    //## auto_generated 
    public void _removeItsGen_BS_2(Gen_BS p_Gen_BS) {
        itsGen_BS_2.remove(p_Gen_BS);
    }
    
    //## auto_generated 
    public void removeItsGen_BS_2(Gen_BS p_Gen_BS) {
        if(p_Gen_BS != null)
            {
                p_Gen_BS._removeItsGen_BS_1(this);
            }
        _removeItsGen_BS_2(p_Gen_BS);
    }
    
    //## auto_generated 
    public void _clearItsGen_BS_2() {
        itsGen_BS_2.clear();
    }
    
    //## auto_generated 
    public void clearItsGen_BS_2() {
        ListIterator<Gen_BS> iter = itsGen_BS_2.listIterator();
        while (iter.hasNext()){
            Gen_BS current = itsGen_BS_2.get(iter.nextIndex());
            if(current != null)
                {
                    current._removeItsGen_BS_1(this);
                }
            iter.next();
        }
        _clearItsGen_BS_2();
    ...
    public void removeItsGen_IN(Gen_IN p_Gen_IN) {
        if(p_Gen_IN != null)
            {
                p_Gen_IN._removeItsGen_BS(this);
            }
    ...
    public void removeItsGen_MN(Gen_MN p_Gen_MN) {
        if(p_Gen_MN != null)
            {
                p_Gen_MN._removeItsGen_BS(this);
            }
    ...
    public void removeItsGen_SN(Gen_SN p_Gen_SN) {
        if(p_Gen_SN != null)
            {
                p_Gen_SN._removeItsGen_BS(this);
            }
    ...
    public void _setItsManager_2(Manager p_Manager) {
        if(itsManager_2 != null)
            {
                itsManager_2._removeItsGen_BS(this);
            }
